...
@Generated("")
@OpenAPIDefinition(
	info = @Info(description = "TestRestUsers REST API", license = @License(name = "Apache 2.0", url = "http://www.apache.org/licenses/LICENSE-2.0.html"), title = "TestRestUsers", version = "v1.0")
)
@Path("/v1.0")
