...
public abstract class BaseUserResourceImpl implements UserResource {
	 ...
	 *
	 * curl -X 'POST' 'http://localhost:8080/o/AddUserRestBuilder/v1.0/add-user' -d $'{"email": ___, "firstName": ___, "lastName": ___, "password1": ___, "password2": ___, "role": ___, "screenName": ___}' --header 'Content-Type: application/json' -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.tags.Tags(
		value = {@io.swagger.v3.oas.annotations.tags.Tag(name = "User")}
	)
	@javax.ws.rs.Consumes({"application/json", "application/xml"})
	@javax.ws.rs.Path("/add-user")
	@javax.ws.rs.POST
