...
public class UserObject implements Serializable {
	...
	public static UserObject unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(UserObject.class, json);
	}
	...
	@Schema(
		...
		defaultValue = "AddUserRestBuilder.dto.v1_0.UserObject",
		name = "x-class-name"
	)
