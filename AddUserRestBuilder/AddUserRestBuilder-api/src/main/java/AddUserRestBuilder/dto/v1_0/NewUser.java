package AddUserRestBuilder.dto.v1_0;
...
public class NewUser implements Serializable {
	...
	public static NewUser toDTO(String json) {
		return ObjectMapperUtil.readValue(NewUser.class, json);
	}

	public static NewUser unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(NewUser.class, json);
	}
	...
	@Schema(
		...
		defaultValue = "AddUserRestBuilder.dto.v1_0.NewUser",
		name = "x-class-name"
	)
